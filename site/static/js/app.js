...
/* As escalas saem das VARIÁVEIS DO CSS, não de uma cópia aqui.
   Duas listas com a mesma informação divergem em silêncio. No observatório de
   Psicologia isto aconteceu: o CSS virou índigo e a cópia em JS continuou
   teal, e a tabela do índice e todo mapa sequencial passaram a desenhar na cor
   do observatório irmão, sem erro no console e sem nada que acusasse. É o
   mesmo defeito que o catálogo único de indicadores existe para impedir,
   cometido na camada de cor — e aqui `tests/test_acessibilidade.py` compara as
   duas listas a cada execução.
...
const SEQ = _escalaDoCss('seq', 8,
  ['#EEF3F1', '#D5E3DE', '#B5CDC5', '#8FB4A9',
   '#69988C', '#46796C', '#2F6F5E', '#234E44']);
