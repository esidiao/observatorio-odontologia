...
def aba_leia_me(wb, nacional, proveniencia):
    ...
    linhas = [
        ("Observatório Nacional da Formação em Odontologia", None),
        ("", None),
...
def gerar(saida, dir_dados=None, nomes_uf=None):
    ...
    wb.properties.title = "Observatório Nacional da Formação em Odontologia"
    ...
    wb.properties.description = (
        ...
        "dos cursos de Odontologia no Brasil.")
